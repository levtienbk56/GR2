...
public class Sequence<T>{
	 ...
	 */
	private final List<List<T>> itemsets = new ArrayList<List<T>>();
	/** id of this sequence */
	private int id; 
	 ...
	 */
	public List<List<T>> getItemsets() {
		return itemsets;
	}
	 ...
	 */
	public Sequence cloneSequenceMinusItems(Map<T, Set<Integer>> mapSequenceID, double relativeMinSup) {
		// create a new sequence
		Sequence sequence = new Sequence(getId());
		// for each  itemset in the original sequence
		for(List<T> itemset : itemsets){
			// call a method to copy this itemset
			List<T> newItemset = cloneItemsetMinusItems(itemset, mapSequenceID, relativeMinSup);
	 ...
	 */
	public List<T> cloneItemsetMinusItems(List<T> itemset,Map<T, Set<Integer>> mapSequenceID, double relativeMinsup) {
		// create a new itemset
		List<T> newItemset = new ArrayList<T>();
